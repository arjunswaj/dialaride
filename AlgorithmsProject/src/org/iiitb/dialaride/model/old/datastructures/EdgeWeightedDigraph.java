...
public class EdgeWeightedDigraph {
	 ...
	 * Create a edge-weighted digraph with V vertices and E edges.
	 */
	public EdgeWeightedDigraph(int V, List<DirectedEdge> edges) {
		this(V);
		E = edges.size();
		if (E < 0)
			throw new IllegalArgumentException(
	 ...
	 * in.readInt(); for (int i = 0; i < E; i++) { int v = in.readInt(); int w =
	 * in.readInt(); double weight = in.readDouble(); addEdge(new
