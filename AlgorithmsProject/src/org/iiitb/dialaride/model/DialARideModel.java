...
public class DialARideModel {
  ...
  public void setRideRequests(SortedMap<Integer, List<RideRequest>> rideRequests) {
    this.rideRequests = rideRequests;
  }
  ...
  public void setSuccessfullyScheduledRequests(int successfullyScheduledRequests) {
  ...
  public Map<Integer, Cab> getCabsLookUp() {
    return cabsLookUp;
  }

  public void setCabsLookUp(Map<Integer, Cab> cabsLookUp) {
    this.cabsLookUp = cabsLookUp;
  }
